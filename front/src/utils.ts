...
export const statuses: DonationStatus[] = [
  'pending',
  'succeeded',
  'declined',
  'cancelled',
...
export const canEditCampaigns = (role: Role) =>
...
export const enumLabel = (lang: Lang, group: string, value: string) =>
  tx(lang, `${group}.${value}`, value);

export const roleLabel = (lang: Lang, role: Role) =>
  enumLabel(lang, 'role', role);
