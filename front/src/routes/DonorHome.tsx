...
export const DonorHome = ({ lang }: { lang: Lang }) => {
    ...
    const submit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setError(requestError instanceof Error ? requestError.message : t(lang, 'donationFailed'));
        } finally {
            setSubmitting(false);
        }
    };
            ...
            <section className="animate-fade-in">
                ...
                {campaign ? (
                    <Card className="mt-8 overflow-hidden p-0">
                        <div className="h-2 w-full" style={{ backgroundColor: campaign.color }} aria-hidden="true" />
                        <div className="p-6">
            ...
            <Card className="animate-scale-in p-6">
                ...
                <form className="mt-6 grid gap-5" onSubmit={submit}>
                    ...
                    <fieldset>
                        ...
                        {receiptError && <FieldError id="receipt-error" error={receiptError} />}
                    </fieldset>
