const SENSITIVE_KEYS = new Set(['password', 'card', 'token', 'authorization', 'cookie', 'pan', 'cvv', 'expiry']);
...
const write = (level: LogLevel, context: string, message: string, meta: Record<string, unknown> = {}) => {
