...
const auditedDonationExport = async (context: Context, successAction: string, failureAction: string) => {
...
export const exportCsv = async (context: Context) => {
    const donationsResult = await auditedDonationExport(context, 'donations_exported', 'donations_export_failed');
